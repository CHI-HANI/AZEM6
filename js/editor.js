...
function obFinish() {
  ...
  // ✅ احفظ onboardingDone في Firestore حتى لا يُعاد إظهار الـ onboarding عند تسجيل الدخول لاحقاً
...
function obSetAuthMode(mode) {
  ...
  if (mode === 'signup') {
    ...
    // دخول: أخفِ حقل الاسم، استدعِ auth مباشرة
