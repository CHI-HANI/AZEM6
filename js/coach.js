...
function deRenderLibGrid() {
  ...
  grid.innerHTML = filtered.map(ex => {
    ...
    return `<div onclick="deLibAddEx('${ex.id}')" style="border-radius:16px;background:var(--card);border:2px solid ${borderColor};cursor:pointer;position:relative;padding-top:100%;overflow:hidden;">`
      + `<div style="position:absolute;inset:0;background:${bgTint};border-radius:14px;overflow:hidden;">`
